...
# 트랙 번호 -> 트랙 ID 매핑
TRACK_MAPPING = {
    '1_1': ('sleep_01', '스탠다드 자장가'),
    '1_2': ('sleep_02', '따뜻한 오후'),
    '1_3': ('sleep_03', '깊은 밤의 꿈'),
    '1_4': ('sleep_04', '엄마의 요람'),
    '1_5': ('sleep_05', '깊은 울림'),
    '1_6': ('sleep_06', '포근한 왈츠'),
    '1_7': ('sleep_07', '맑은 아침'),
    ...
    '2_3': ('separation_03', '균형 잡힌 안정'),
    '2_4': ('separation_04', '포근한 공기'),
    '2_5': ('separation_05', '산뜻한 안정'),
    '2_6': ('separation_06', '밝은 공기'),
    '2_7': ('separation_07', '평온한 오후'),
    '2_8': ('separation_08', '숲속의 쉼터'),
    '3_1': ('noise_01', '부드러운 장막'),
    '3_2': ('noise_02', '깊은 방패'),
    '3_3': ('noise_03', '일상의 평온'),
    '3_4': ('noise_04', '든든한 방음벽'),
    '3_5': ('noise_05', '산뜻한 보호막'),
    '3_6': ('noise_06', '포근한 담요'),
    '3_7': ('noise_07', '우주 여행'),
    '3_8': ('noise_08', '깊은 바다'),
    '4_1': ('energy_01', '리드미컬 산책'),
    '4_2': ('energy_02', '활기찬 터그'),
    '4_3': ('energy_03', '경쾌한 총총'),
    '4_4': ('energy_04', '신나는 술래'),
    '4_5': ('energy_05', '사뿐한 총총'),
    '4_6': ('energy_06', '신나는 우다다'),
    '4_7': ('energy_07', '피크닉'),
    '4_8': ('energy_08', '댄스 타임'),
    '5_1': ('senior_01', '치유의 주파수'),
    '5_2': ('senior_02', '깊은 안정'),
    '5_3': ('senior_03', '부드러운 공명'),
    '5_4': ('senior_04', '편안한 휴식'),
    '5_5': ('senior_05', '포근한 온기'),
    '5_6': ('senior_06', '산뜻한 평온'),
    '5_7': ('senior_07', '영혼의 안식'),
    '5_8': ('senior_08', '자연의 품'),
}
